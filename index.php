...
<div class="main-slider overlape">
    <div id="navforsan" style="position: relative;">
        <div id="layerslider" style="width:100%; height:696px; overflow: hidden; position: relative;">
            ...
            <div class="ls-slide" data-ls="transition2d:35; timeshift:-1000; slidedelay: 9000;">
                ...
                <div class="ls-slide" style="line-height:28px; font-family:raleway; font-size:20px; color:#ffffff; top:445px; left:100px;" data-ls="offsetxout:left; offsetxin:right; durationin:1300; delayin:1200; easingin:easeOutBack; fadein:false; easingout:easeInBack; fadeout:false;">ALKAFAA is a reliable supplier for full range<br />of Carbon Steel, Stainless Steel Pipes,<br />Fittings, Sheets & Valve.</div>
            ...
            <a href="#" class="slider-prev" style="position:absolute; top:50%; left:20px; transform:translateY(-50%); background:#1c3f94; padding:10px; color:#fff; z-index:999;">❮</a>
            <a href="#" class="slider-next" style="position:absolute; top:50%; right:20px; transform:translateY(-50%); background:#1c3f94; padding:10px; color:#fff; z-index:999;">❯</a>
