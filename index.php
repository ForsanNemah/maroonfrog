    ...
    <div id="full-slider-wrapper" style="position:relative;">
        <div id="layerslider" style="width:100%; height:696px;">
            ...
            <div class="ls-slide" data-ls="transition2d:30; timeshift:-1000; slidedelay:6000;">
                ...
                <span class="ls-slide" style="top:290px; left:48%; font-family:raleway; color:#ffffff; border-radius:3px; padding:12px 40px; background-color:#1c3f94; font-size:20px; font-weight:200;" data-ls="offsetyout:bottom; offsetyin:top; durationin:1300; delayin:500; easingin:easeOutBack; fadein:false; easingout:easeInBack; fadeout:false;">
            ...
            <div class="ls-slide" data-ls="transition2d:35; timeshift:-1000; slidedelay:9000;">
                ...
                <div class="ls-slide" style="line-height:28px; font-family:raleway; font-size:20px; color:#ffffff; top:445px; left:100px;" data-ls="offsetxout:left; offsetxin:right; durationin:1300; delayin:1200; easingin:easeOutBack; fadein:false; easingout:easeInBack; fadeout:false;">
            ...
            <div class="ls-slide" data-ls="transition2d:40; timeshift:-1000; slidedelay:6000;">
                ...
                <span class="ls-slide" style="top:390px; left:50%; font-family:raleway; color:#ffffff; border-radius:3px; padding:12px 40px; background-color:#1c3f94; font-size:20px; font-weight:200;" data-ls="offsetyout:bottom; offsetyin:top; durationin:1300; delayin:500; easingin:easeOutBack; fadein:false; easingout:easeInBack; fadeout:false;">
        ...
        <div class="slider-nav">
            <button class="slider-prev" onclick="layerSlider.prev()">&#10094;</button>
            <button class="slider-next" onclick="layerSlider.next()">&#10095;</button>
        </div>
...
<script>
// Make sure LayerSlider object is ready
var layerSlider;
document.addEventListener('DOMContentLoaded', function() {
    layerSlider = $('#layerslider').layerSlider({
        // your slider options if needed
    }).data('layerSlider');
});
</script>
