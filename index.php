    ...
    <div id="full-slider-wrapper" style="position: relative;">
        <div id="layerslider" style="width:100%; height:696px; overflow: hidden; position: relative;">
            ...
            <div class="ls-slide" data-ls="transition2d:30; timeshift:-1000; slidedelay: 6000;">
                ...
                <span class="ls-slide" style="top:290px; left:48%; font-family:raleway; color:#ffffff; border-radius:3px; padding:12px 40px; background-color:#1c3f94; font-size:20px; font-weight:200;" data-ls="...">
            ...
            <div class="ls-slide" data-ls="transition2d:35; timeshift:-1000; slidedelay: 9000;">
                ...
                <div class="ls-slide" style="font-family:raleway; font-weight:700; font-size:40px; ...">Together We Are</div>
                <div class="ls-slide" style="font-family:raleway; font-size:50px; ...">"Together We<br />&nbsp;&nbsp;Thrive"</div>
                <div class="ls-slide" style="line-height:28px; font-family:raleway; font-size:20px; ...">ALKAFAA is a reliable supplier for...</div>
                <a href="/about-us" itemprop="url" class="ls-slide slide-icon" style="padding:16px 45px; background:#1c3f94; color:#ffffff; font-size:12px;">More About Us</a>
            </div>
            ...
            <div class="ls-slide" data-ls="transition2d:40; timeshift:-1000; slidedelay: 6000;">
                ...
                <h4 class="ls-slide text-color" style="top:324px; left:50%; font-family:raleway; font-size:30px;">Established in 1982</h4>
                <span class="ls-slide" style="top:390px; left:50%; ...">"Backed by more than 4 decades of experience"</span>
            </div>
            ...
            <div class="ls-slide" data-ls="transition2d:30; timeshift:-1000; slidedelay: 6000;">
                ...
                <h3 class="ls-slide text-color" style="top:260px; left:50%; font-size:30px;">"Leading Stockiest Company in Saudi Arabia"</h3>
                <strong class="ls-slide" style="top:345px; left:50%; padding:14px 25px; background:#1c3f94;">Fast &amp; Secure Delivery</strong>
            </div>

            <!-- Prev and Next Buttons -->
            <button id="prev-slide" style="position:absolute; top:50%; left:20px; transform:translateY(-50%); background:#1c3f94; color:#fff; border:none; padding:10px 20px; cursor:pointer; z-index:1000;">Prev</button>
            <button id="next-slide" style="position:absolute; top:50%; right:20px; transform:translateY(-50%); background:#1c3f94; color:#fff; border:none; padding:10px 20px; cursor:pointer; z-index:1000;">Next</button>
...
document.addEventListener('DOMContentLoaded', function () {
    const slides = document.querySelectorAll('#layerslider .ls-slide');
    let currentSlide = 0;
