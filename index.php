...
<div class="main-slider overlape">
    <div id="navforsan" style="position: relative;">
        <div id="layerslider" style="width:100%; height:696px; overflow: hidden; position: relative;">
            ...
            <div class="ls-slide active" data-ls="transition2d:30;">
                <img itemprop="image" src="<?php bloginfo('template_url');?>/images/maroonfrog/slider004.jpg" class="ls-bg" alt="Slide background" />
                <span class="ls-slide" style="top:290px; left:48%; font-family:raleway; color:#ffffff; background-color:#1c3f94; padding:12px 40px;">ALKAFAA is an approved stockiest for SAUDI ARAMCO, SABIC, etc.</span>
            </div>

            <div class="ls-slide" data-ls="transition2d:35;">
                <img itemprop="image" src="<?php bloginfo('template_url');?>/images/maroonfrog/slider001.jpg" class="ls-bg" alt="Slide background" />
                <div class="ls-slide" style="top:214px; left:100px; font-family:raleway; font-size:40px; color:#f58426;">Together We Are</div>
            </div>
            ...
            <div class="ls-slide" data-ls="transition2d:40;">
                ...
                <h4 class="ls-slide" style="top:324px; left:50%; font-family:raleway; color:#f58426;">Established in 1982</h4>
            </div>

            <div class="ls-slide" data-ls="transition2d:30;">
                <img itemprop="image" src="<?php bloginfo('template_url');?>/images/maroonfrog/slider003.jpg" class="ls-bg" alt="Slide background" />
                <div class="ls-slide" style="top:223px; left:50%; font-family:raleway; font-size:30px; color:#ffffff;">Leading Stockiest Company</div>
            </div>

            <!-- Next and Prev Buttons -->
            <a href="#" id="prevBtn" style="position:absolute; top:50%; left:20px; transform:translateY(-50%); background:#1c3f94; padding:10px; color:#fff; z-index:999;">❮</a>
            <a href="#" id="nextBtn" style="position:absolute; top:50%; right:20px; transform:translateY(-50%); background:#1c3f94; padding:10px; color:#fff; z-index:999;">❯</a>
