        ...
        <div class="top-bar">
          <div class="container">
            ...
            <div class="extra-links">
              <a itemprop="url" href="<?php echo esc_url( home_url( '/' ) ); ?>contact-us" title="Contact Us">Contact Us</a> / 
              <a itemprop="url" href="<?php echo esc_url( home_url( '/' ) ); ?>careers" title="Careers">Careers</a> / 
              <a style="font-family: Raleway;" itemprop="url" href="<?php echo esc_url( home_url( '/' ) ); ?>ar" title="عربي">عربي</a>
            </div>
          </div>
        </div>
      </div><!-- Top Sec -->
          ...
          <div class="logo-menu">
            <div class="logo">
              <a itemprop="url" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                <img itemprop="image" src="<?php bloginfo('template_url');?>/images/maroonfrog/logo-alkafaa.png" alt="" />
              </a>
            </div>
            <div class="quick-contact">
              <ul>
                ...
                <li>
                  <a href="#" itemprop="url" class="theme-btn popup2" title="REQUEST A QUOTE">REQUEST A QUOTE</a>
                </li>
              </ul>
            </div>
          </div>
